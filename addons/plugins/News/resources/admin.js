var AdminProfiles = {
	...
	showEditSheet: function(fieldId, formData) {
		ETSheet.loadSheet("editFieldSheet", "admin/news/edit.view/"+fieldId, function() {
	...
	showCreateSheet: function(formData) {
		ETSheet.loadSheet("editFieldSheet", "admin/news/create.view/", function() {
