...
ET::$skinInfo["Timeline"] = array(
	"name" => "Timeline",
	"description" => "The Timeline esoTalk skin.",
	"version" => ESOTALK_VERSION,
	"author" => "Alan Araujo",
	"authorEmail" => "hello@4lan4raujo.com",
	"authorURL" => "http://4lan4raujo.com/forum",
	"license" => "GPLv2"
);

class ETSkin_Timeline extends ETSkin {
...
{
	$sender->addCSSFile((C("esoTalk.https") ? "https" : "http")."://fonts.googleapis.com/css?family=ABeeZee:400,600");
	$sender->addCSSFile("core/skin/font-awesome.css", true);
	$sender->addCSSFile($this->resource("styles.css"), true);
	$sender->addJSFile($this->resource("timeline.js"));
	$sender->addJSFile($this->resource("modernizr.js"));
	...
	if (!C("skin.Timeline.primaryColor")) $this->writeColors("#364159");
}
...
{
	ET::writeConfig(array("skin.Timeline.primaryColor" => $primary));
...
public function settings($sender)
{
	...
	$form->setValue("primaryColor", C("skin.Timeline.primaryColor"));
