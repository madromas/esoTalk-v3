...
ET::$skinInfo["Nitro"] = array(
	"name" => "Nitro",
	"description" => "The Nitro esoTalk skin.",
	"version" => ESOTALK_VERSION,
	"author" => "WolfGeeN",
	"authorEmail" => "mail@myforum-design.ru",
	"authorURL" => "myforum-design.ru",
	"license" => "GPLv2",
);

class ETSkin_Nitro extends ETSkin {
...
public function handler_init($sender)
{
	...
	if (!C("skin.Nitro.primaryColor")) $this->writeColors("#364159");
}
...
{
	ET::writeConfig(array("skin.Nitro.primaryColor" => $primary));
...
public function settings($sender)
{
	...
	$form->setValue("primaryColor", C("skin.Nitro.primaryColor"));
