...
ET::$skinInfo["ExtendedDefault"] = array(
	"name" => "ExtendedDefault",
	"description" => "An extention to the default esoTalk skin.",
...
class ETSkin_ExtendedDefault extends ETSkin {
...
public function handler_init($sender)
{
	...
	if (!C("skin.ExtendedDefault.primaryColor")) $this->writeColors("#364159");
}
...
{
	ET::writeConfig(array("skin.ExtendedDefault.primaryColor" => $primary));
...
public function settings($sender)
{
	...
	$form->setValue("primaryColor", C("skin.ExtendedDefault.primaryColor"));
