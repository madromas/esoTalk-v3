...
<?php endforeach; ?>
<?php /*if ($data["hidden"] > 0): ?><li class='help'><?php printf(T("%d hidden"), $data["hidden"]); ?></li><?php endif; */ // vanGato ?>
<?php if ($data["hidden"] > 0): ?><li class='help'><?php printf(T("%d ".T("message.hidden")), $data["hidden"]); ?></li><?php endif; ?>
</ul>
