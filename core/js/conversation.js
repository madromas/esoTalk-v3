...
initReply: function() {
	...
	if (!ET.iOS) textarea.TextAreaExpander(200, 400);
...
initPosts: function() {
	...
	$("#conversationPosts .markAsAnswer").tooltip({alignment: "left", className: "withArrow withArrowBottom"});
...
updateEditPost: function(postId, html) {
	...
	if (!ET.iOS) textarea.TextAreaExpander(200, 400).focus().selectRange(len, len);
